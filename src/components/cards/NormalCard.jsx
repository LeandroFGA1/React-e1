    ...
    return (
        <NormalCardContainer>
            <NormalCardItem className='normal-card'>
                <ImageCard className='imagebg-normal-card'>
                    <ShadowBG className='shadow-bg-normal-card'>
